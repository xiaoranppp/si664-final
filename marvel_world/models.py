...
class Character(models.Model):
    ...
    alignment = models.ForeignKey('Alignment',   on_delete=models.PROTECT,blank=True, null=True)
    gender = models.ForeignKey('Gender',   on_delete=models.PROTECT,blank=True, null=True)
    eye_color = models.ForeignKey('EyeColor',   on_delete=models.PROTECT,blank=True, null=True)
    race = models.ForeignKey('Race',   on_delete=models.PROTECT,blank=True, null=True)
    hair_color = models.ForeignKey('HairColor',   on_delete=models.PROTECT,blank=True, null=True)
    publisher = models.ForeignKey('Publisher',   on_delete=models.PROTECT,blank=True, null=True)
    skin_color = models.ForeignKey('SkinColor',  on_delete=models.PROTECT,blank=True, null=True)
